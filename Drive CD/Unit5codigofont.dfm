  ...
  object RichEdit1: TRichEdit
    ...
    Lines.Strings = (
      ...
      'begin'
        ...
        'showmessage('#39'Eu mandei não clicar, você quis ser curioso agora v' +
        'ai ver só..., você tem 60 '
      ...
      'begin'
      'showmessage('#39'Tem certeza que é esse'#39');'
      'end;'
      ''
      ...
      'else'
      'begin'
      'Showmessage('#39'Erro palhaço'#39');'
      'end;'
      ''
      'end;'
      ''
        ...
        'tion);'
      'begin'
      'Showmessage('#39'Não sabe a senha né mané'#39');'
      'end;'
      ''
      'end.'
      ''
      ...
      ''
        ...
        '----------------------------------------------------------'
      ''
      'ESTE É O CÓDIGO FONTE DE TODO O PROGRAMA NELE VOCÊ PODE'
      ''
