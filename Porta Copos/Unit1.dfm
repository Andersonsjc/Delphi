object Form1: TForm1
  ...
  object Panel1: TPanel
    ...
    object RichEdit1: TRichEdit
      ...
      Font.Style = [fsBold]
      Lines.Strings = (
        'Caro amigo usuário de computador:'
        ''
        'Agora você já pode obter uma das maiores '
        'tecnologias já inventadas até hoje.'
        'Se trata nada mais nada menos de que um '
        'belíssimo porta copos para você poder'
        'tomar sua cerveja.'
        ''
        'Para que você possa usufruir desse '
        'moderno Porta Copos, pressione o botão '
        'abaixo.'
        '')
      ParentFont = False
      TabOrder = 0
